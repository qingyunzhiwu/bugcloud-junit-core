...
#### 介绍
[BugCloud Junit Core](https://github.com/qingyunzhiwu/bugcloud-junit-core)是[BugCloud](http://www.bug-cloud.com)推出的Java单元测试功能包，目标是用最少的代码完成单元测试，减少开发人员在单元测试过程中的代码开发量，并可将测试结果发送到[BugCloud云平台](http://www.bug-cloud.com)，提高软件开发、Bug修复及项目管理交付的效率。
...
###### PushReport 类注解
**用能：**  
在测试完成后，将失败的测试结果发送到[BugCloud云平台](http://www.bug-cloud.com)。  
**参数说明：**  
